...
export const adminApi = {
  ...
  updateReviewReply: (id, reply) => api.patch(`/admin/reviews/${id}/reply`, { reply }),
  rejectReviewReply: (id, note) => api.post(`/admin/reviews/${id}/reply/reject`, { note }),
  ...
  getClaims: (status) => api.get(`/admin/claims${status ? `?status=${encodeURIComponent(status)}` : ''}`),
  getClaim: (id) => api.get(`/admin/claims/${id}`),
  updateClaimVerification: (id, data) => api.patch(`/admin/claims/${id}/verification`, data),
  reviewClaim: (id, data) => api.post(`/admin/claims/${id}/review`, data),
  getBusinessUsers: (id) => api.get(`/admin/businesses/${id}/users`),
  addBusinessUser: (id, data) => api.post(`/admin/businesses/${id}/users`, data),
  ...
  getBillingPlans: () => api.get('/admin/billing-plans'),
  updateBillingPlan: (key, data) => api.put(`/admin/billing-plans/${key}`, data),
  syncBillingPlan: (key) => api.post(`/admin/billing-plans/${key}/sync`),
  syncAllBillingPlans: () => api.post('/admin/billing-plans/sync-all'),
